...
<div class="container">
    <div class="product-container">
        <!-- Product Image -->
        <div>
            <img src="prod5.jpg" alt="Product Image" class="product-image">
        </div>
        ...
        <div class="product-details">
            <h2>Casio Vintage</h2>
            <p class="product-description">The Casio Vintage Watch is a timeless blend of retro aesthetics and modern functionality, making it the perfect accessory for any occasion. Its sleek metallic finish and compact digital display exude classic charm while effortlessly complementing both casual and formal outfits. Designed for everyday wear, this lightweight yet durable timepiece features a clear digital screen that displays the time, date, and day of the week at a glance.</p>
            <p class="product-price">PHP 1,080.00</p>
        </div>
    </div>
</div>
