...
<head>
    ...
    <title>Cartier Drive de Cartier</title>
...
<div class="container">
    <div class="product-container">
        <!-- Product Image -->
        <div>
            <img src="prod3.jpg" alt="Product Image" class="product-image">
        </div>


        <!-- Product Details -->
        <div class="product-details">
            <h2>Cartier Drive de Cartier</h2>
            <p class="product-description">Santos-Dumont watch, extra-large model, Manufacture mechanical movement with manual winding, calibre 430 MC. Steel case, beaded steel crown set with a blue synthetic spinel cabochon, silvered satin-finish sunray-effect dial, Roman numerals, blued-steel sword-shaped hands, sapphire crystal. Navy blue alligator-skin strap, steel ardillon buckle. Case dimensions: 46.6 mm x 33.9 mm, thickness: 7.5 mm. Water-resistant to 3 bar (approx. 30 metres).</p>
            <p class="product-price">PHP 200,580.00</p>
        </div>
    </div>
</div>
...
<div class="other-products">
    ...
    <div class="container">
        <div class="row">
            ...
            <!-- Product 2 -->
            <div class="col-lg-3 col-md-4 col-sm-6 product-card">
                <a href="product13.php"><img src="prod2.jpg" alt="Product 2" class="img-fluid"></a>
                <div class="product-name">Cartier Drive de Cartier</div>
            </div>

            <!-- Product 4 -->
            <div class="col-lg-3 col-md-4 col-sm-6 product-card">
                <a href="product15.php"><img src="prods4.jpg" alt="Product 4" class="img-fluid"></a>
