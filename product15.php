...
<head>
    ...
    <title>Cartier Silver Delux Vintage</title>
...
<div class="container">
    <div class="product-container">
        <!-- Product Image -->
        <div>
            <img src="prod4.jpg" alt="Product Image" class="product-image">
        </div>


        <!-- Product Details -->
        <div class="product-details">
            <h2>Cartier Silver Delux Vintage</h2>
            <p class="product-description">This timeless Vintage Cartier Silver Delux watch is crafted in sensual 32.4 grams of platinum. This flexible link watch was created in the 1960s era.   Features 10 large baguettes cut Diamonds and 108 round faceted icy white Diamonds surrounding. Weighing approx. 6.80 carats</p>
