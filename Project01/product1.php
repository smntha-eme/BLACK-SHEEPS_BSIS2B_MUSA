...
<head>
    ...
    <title>Cartier Ronde Louis Cartier</title>
...
<div class="cart-icon-container">
 ...
 <div class="container">
    <div class="product-container">
        <!-- Product Image -->
        <div>
            <img src="casio6.jpg" alt="Product Image" class="product-image">
        </div>


        <!-- Product Details -->
        <div class="product-details">
            <h2>Casio Silver Deluxe</h2>
            <p class="product-description">The Casio Silver Deluxe is a sleek and elegant timepiece that combines modern design with classic functionality. Featuring a durable stainless steel case, a stylish silver-tone finish, and a reliable quartz movement, this watch offers precision and sophistication for any occasion. Its minimalist dial and comfortable bracelet make it an ideal accessory for both casual and formal wear. Perfect for those who appreciate quality craftsmanship and timeless style.</p>
            <p class="product-price">PHP 1,000.00</p>
        </div>
    </div>
</div>
