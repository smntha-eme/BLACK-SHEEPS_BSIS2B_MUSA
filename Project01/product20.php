...
<head>
    ...
    <title>Rolex Oyster Perpetual</title>
...
<div class="cart-icon-container">
 ...
 <div class="container">
    <div class="product-container">
        <!-- Product Image -->
        <div>
            <img src="prod9.jpg" alt="Product Image" class="product-image">
        </div>


        <!-- Product Details -->
        <div class="product-details">
            <h2>Rolex Oyster Perpetual</h2>
            <p class="product-description">The Rolex Oyster Perpetual is a classic timepiece featuring a rose gold case and a brown-accented clock face, blending elegance with timeless design.</p>
            <p class="product-price">PHP 220,350.00</p>
        </div>
    </div>
</div>
