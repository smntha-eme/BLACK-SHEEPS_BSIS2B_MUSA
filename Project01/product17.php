...
<div class="cart-icon-container">
 ...
 <div class="container">
    <div class="product-container">
        <!-- Product Image -->
        <div>
            <img src="prod6.jpg" alt="Product Image" class="product-image">
        </div>


        <!-- Product Details -->
        <div class="product-details">
            <h2>Rolex Day Date-40</h2>
            <p class="product-description">The Iconic Rolex Day-Date 40 is a luxurious watch featuring elegant gold accents and a vibrant green clock face, embodying timeless sophistication and prestige.</p>
            <p class="product-price">PHP 120,280.00</p>
        </div>
    </div>
</div>
